        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutSectionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutSectionDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutSectionDetails_AboutSections_AboutSectionId",
                        column: x => x.AboutSectionId,
                        principalTable: "AboutSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AboutSectionDetails_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeroSectionDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HeroSectionDetails_HeroSections_HeroSectionId",
                        column: x => x.HeroSectionId,
                        principalTable: "HeroSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HeroSectionDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpeakerDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SpeakerDetails_Speakers_SpeakerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SponsorDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SponsorDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SponsorDetails_Sponsors_SponsorId",
                        column: x => x.SponsorId,
                        principalTable: "Sponsors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventDetails_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AboutSectionDetails_AboutSectionId",
                table: "AboutSectionDetails",
                column: "AboutSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_AboutSectionDetails_LanguageId",
                table: "AboutSectionDetails",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpeakerDetails_LanguageId",
                table: "SpeakerDetails",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_SpeakerDetails_SpeakerId",
                table: "SpeakerDetails",
                column: "SpeakerId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorDetails_LanguageId",
                table: "SponsorDetails",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorDetails_SponsorId",
                table: "SponsorDetails",
                column: "SponsorId");
